...
Data vs Judgment. 69개 디자인 룰을 Claude Code와 Cursor가 자동으로 읽어요. 결과물이 "생성된 것" 처럼 안 보이고 "디자인된 것" 처럼 나옵니다.

<br />

[사용법](#사용법) · [왜-필요한가](#왜-필요한가) · [AI-스킬-11개](#ai-스킬-10개) · [Wiki](../../wiki)
...
StyleSeed는 **디자인 엔진**입니다. 69개 시각 룰, 48개 컴포넌트, 11개 슬래시 커맨드가 LLM에게 데이터가 아니라 판단을 가르칩니다:
...
seed를 복사하면 **슬래시 명령어 11개**를 쓸 수 있습니다 — UI 6개 + UX 4개:
